<template>
  <div class="map">
    <div style="z-index:99999;background-color:red;position:absolute;top:20px;left:50%;">
      ...
      <b-collapse class="panel box is-paddingless" :open.sync="panelOpen">
        ...
        <div class="panel-block" v-show="mapPanel.tab === 'state'">
          <table class="table is-fullwidth">
            <tr>
              <th>Map center</th>
              <td id="valorCod">{{ center }}</td>
            </tr>
            <tr>
              <th>Map zoom</th>
              <td id="valorZoom" >{{ zoom }}</td>
            </tr>
            <tr>
              <th>Map rotation</th>
              <td>{{ rotation }}</td>
...
export default {
  ...
  methods: {
    ...
    teste:function(){
      valorCod = document.getElementById("valorCod").innerText
      valorZoom = document.getElementById("valorZoom").innerText

      if(valorCod[0] != 0 && valorCod[1] != 0){
        valorCod = [0,0]
        valorZoom = 2
      }
      console.log(valorCod)
